...
import com.syt.Notepad.adapter.GridViewAdapter;
...
public class AddBill extends Activity implements OnClickListener {
	...
	private void initSelectColor() {
		pay_btn.setBackgroundColor(Color.parseColor("#87CEEB"));
		income_btn.setBackgroundColor(Color.parseColor("#FFFFFF"));
		pay_btn.setTextColor(Color.parseColor("#FFFFFF"));
		income_btn.setTextColor(Color.parseColor("#000000"));
